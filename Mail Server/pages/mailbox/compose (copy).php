            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body">
			      ...
			      <input class="form-control" name="to" placeholder="To:"/>  </div>
			      
                  <div class="form-group">  <input class="form-control" name="sub" placeholder="Subject:"/> </div>
                  
                  <div class="form-group"> <textarea id="compose-textarea" ame="msg" class="form-control" style="height: 300px"> </textarea>  </div>
                 
                
                </div><!-- /.box-body -->
                <div class="box-footer">
                  <div class="pull-right">
                    <button class="btn btn-default"><i class="fa fa-pencil" name="save"></i> Draft</button>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"  name="send"></i> Send</button> </div>
